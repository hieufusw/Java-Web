...
public class ReadFileUtil extends HttpServlet {

    private static final long serialVersionUID = 1224310784719415842L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int repIndex = imageUrl.indexOf("/SE1215ASM/repository/");
        String relativeImagePath = null;
        if (repIndex != -1) {
            repIndex += "/SE1215ASM/repository/".length();
